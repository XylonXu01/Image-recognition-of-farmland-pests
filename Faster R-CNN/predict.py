...
def main():
    ...
    # load train weights
    weights_path = "/home/featurize/Faster_Rcnn_weight/efficientnet_b0Fpn-model-14.pth"
    ...
    # load image
    original_img = Image.open("/home/featurize/data/injurious_insect/JPEGImages/00364.jpg")
