...
def create_model(num_classes):
    ...
    model = FasterRCNN(backbone=backbone_with_fpn,
                       num_classes=91, # coco数据集分类个数90+1
...
def main(args):
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        torch.save(save_files, "/home/featurize/Faster_Rcnn_coco_weight/efficientnet_b0Fpn_coco-model-{}.pth".format(epoch))
...
if __name__ == "__main__":
    ...
    # 文件保存地址
    parser.add_argument('--output-dir', default='/home/featurize/Faster_Rcnn_coco_weight', help='path where to save')
    # 若需要接着上次训练，则指定上次训练保存权重文件地址
    parser.add_argument('--resume', default='/home/featurize/save_coco_weight/model-9.pth', type=str, help='resume from checkpoint')
    # 指定接着从哪个epoch数开始训练
